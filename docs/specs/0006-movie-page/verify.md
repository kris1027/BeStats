...
- [ ] Cold cache spot check: with the dev log open, first load of an unseen movie id sends one TMDB request for body plus metadata (record it if two) → build plan task 1

## Acceptance-criteria coverage
- AC-1 … UI steps 1, 2 · AC-2 … UI 3, 4, 5 · AC-3 … UI 6, 7 · AC-4 … UI 8, 9 · AC-5 … UI 9, 10 · AC-6 … UI 11 · AC-7 … UI 6, 10, 12, 13 · AC-8 … Commands 1, 2 · AC-9 … UI 14, Commands 3 · AC-10 … UI 15, 16 · AC-11 … Commands 4, 6 · AC-12 … UI 15, 17 · AC-13 … Commands 5 · AC-14 … UI 18, 19
